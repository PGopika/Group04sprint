...
/*************************************************************************************************************
 *  FILENAME    :doctor.c
 *  DESCRIPTION : This file defines the functions that are used by doctor to register,to view appointment details,
 *                to record patient medical history, to view patient medical history and to edit the basic information of the doctor
 *
 ***********************************************************************************************************************************/
...
#include <ctype.h>
#include <malloc.h>
#include "../header/dph.h"
#define max_len 15

/*************************************************************************************************************************
 *  FUNCTION NAME : doctor_registration
 *   DESCRIPTION   : This function is used by the new doctor for registering themselves to the portal
 *  
 *   ***********************************************************************************************************************/
 ...
 *   * DESCRIPTION : This function is used by the doctors to view the bookings
 *    *
 *     * ***************************************************************************************************************************/
...
/******************************************************************************************************************************
 *  *  FUNCTION NAME : view_patient_history
 *   *  DESCRIPTION : This function is used by the doctors to add the patients medical history. 
 *    *  
 * ***************************************************************************************************************************/
...
/*********************************************************************************************************************
 *  * FUNCTION NAME: edit_doctor_info
 *   *
 *    * DESCRIPTION : This function is used for editing the doctor's basic information
 *     *
 *      * ******************************************************************************************************************/
...
/********************************************************************************************************************
 *  *
 *   * FUNCTION NAME : view_doctor_info
 *    *
 *     * DESCRIPTION    : This function is used to view the doctor's information.
 *      *
 *       * ******************************************************************************************************************/
...
/***********************************************************************************************************************
 *  *
 *   * FUNCTION NAME : delete_doctor_data
 *    *
 *     * DESCRIPTION   : This function is used to delete the doctor data from the portal.
 *      *
 *       **********************************************************************************************************************/
...
/*************************************************************************************************************************
 *  * FUNCTION NAME : isalpha_validation
 *   *
 *    * DESCRIPTION   : This function is used to validate the inputs are characters only.
 *     *
 *      * *********************************************************************************************************************/
...
/*************************************************************************************************************************
 *  * FUNCTION NAME : isdigit_validation
 *   *
 *    * DESCRIPTION   :This function is used to validate the inputs are numbers only.
 *     *
 *      * **********************************************************************************************************************/
 ...
 *   *
 *    * DESCRIPTION : This function is used to validate the entered password's length,it contains special charcaters,digits,one uppercase letter etc.
 *     *
 *      * ************************************************************************************************************************/
...
/*************************************************************************************************************************
 *  *FUNCTION NAME : doctor_license_query
 *   *
 *    * DESCRIPTION : This function is used by the admin to view appointments of the particular doctor
 *     *
 *      * **********************************************************************************************************************/
...
//This function is to store the doctor data from file to list.
...
int doctor_file_to_list()
{
	...
	FILE *d;
	td td1;
        if((d=fopen("../data/DOCTOR","rb"))==NULL)
        {
...
// This function is used to store doctor data frpm list to file.
...
int doctor_list_to_file()
{
	doctor *ptr,*new;
        ...
        FILE *d1;
        if((d1=fopen("../data/DOCTOR","wb"))==NULL)
        {
                printf("\nFile is not there to read from\n");
                return EXIT_FAILURE;
        }
...
//This function is used to record patient medical history from file to list.
...
// This function is used to record patient medical history from list to file.
