  ...
  *    FILENAME	      : patient.c
  *       
  *    DESCRITION       : This file defines the functions that are used by patient to register and to book appointment. 
  *         
  * ***************************************************************************************************************/
...
/*************************************************************************************
 *  *  FUNCTION NAME	      : patient_registration
 *   *  
 *    *   DESCRITION                : This function is used by the new patient for registration.
 *     *   
 *      * **************************************************************************************/
 ...
 *   * 
 *    * DESCRIPTION     :This function is used to book the appointment for patients according to their preference.
 *     * 
 *      * RETURNS         :Returns the patient appointment details
 *       *********************************************************************************************************/
...
/**********************************************************************************************************
 *  *  FUNCTION NAME   :edit_patient_data
 *   * 
 *    *  DESCRIPTION     :This function is used to edit patient details by admin.
 *     * 
 *      *********************************************************************************************************/
...
/**********************************************************************************************************
 *  * FUNCTION NAME   :view_patient_data
 *   *  
 *    *  DESCRIPTION     :This function is used to view patient details by admin.
 *     *********************************************************************************************************/
...
/**********************************************************************************************************
 *  * FUNCTION NAME   :delete_patient_data
 *   * 
 *    * DESCRIPTION     :This function is used to delete patient details by admin.
 *     *********************************************************************************************************/
...
// This function is to store patient data from file to list.
...
int patient_file_to_list()
{
	...
	FILE *p;
	tp tp1;
        if((p=fopen("../data/PATIENT","rb"))==NULL)
        {
...
//This function is to store patient data from list to file.
...
int patient_list_to_file()
{
	patient *ptr1;
        ...
        FILE *p1;
        if((p1=fopen("../data/PATIENT","wb"))==NULL)
        {
                printf("\nFile is not there to read from\n");
                return EXIT_FAILURE;
        }
...
//This function is to store appointment details from file to list.
...
int book_appointment_file_to_list()
{
	...
	FILE *b;
	tb tb1;
        if((b=fopen("../data/BOOK_APP","rb"))==NULL)
        {
                printf("\nFile is not there to read from\n");
                return EXIT_FAILURE;
        }
...
//This function is to store appointment details from list to file.
...
int book_appointment_list_to_file()
{
	book_app *ptr2;
        ...
        FILE *b1;
        if((b1=fopen("../data/BOOK_APP","wb"))==NULL)
        {
                printf("\nFile is not there to read from\n");
                return EXIT_FAILURE;
        }
